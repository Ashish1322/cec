...
class Designathon(models.Model):
    # total 4 2 compulsary
    type_institution  = models.CharField(
        max_length = 20,
        choices = INT_CHOICES,
        default = 'college'
    ...
    semester2 = models.CharField(null=True,blank=True,default=" ",max_length=5)
    rollno2 = models.CharField(null=True,blank=True,default=" ",max_length=20)
    id2 = models.FileField(upload_to ='Designathon/',blank=True,null=True)
    ...
    semester3 = models.CharField(null=True,blank=True,default="",max_length=3)
    rollno3 = models.CharField(null=True,blank=True,default=" ",max_length=20)
    id3 = models.FileField(upload_to ='Designathon/',blank=True,null=True)

    name4 = models.CharField(max_length=20,default=" ")
    email4 = models.EmailField( max_length=254,null=True,blank=True)
    phone4 = models.CharField(null=True,blank=True,default="",max_length=12)
    branch4 = models.CharField(max_length=50,default=" ")
    semester4 = models.CharField(null=True,blank=True,default="",max_length=3)
    rollno4 = models.CharField(null=True,blank=True,default=" ",max_length=20)
    id4 = models.FileField(upload_to ='Designathon/',blank=True,null=True)
    def __str__(self):
        return self.teamname + " " +self.college

class BreakTheStrategy(models.Model):
    type_institution  = models.CharField(
        max_length = 20,
        choices = INT_CHOICES,
        default = 'college'
...
class Electroinsight(models.Model):
    type_institution  = models.CharField(
        max_length = 20,
        choices = INT_CHOICES,
        default = 'college'
